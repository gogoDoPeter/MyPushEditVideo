...
import com.peter.mypusheditvideo.util.DisplayUtil;
...
public class MyCameraRender implements MyEGLSurfaceView.MyGLRender, SurfaceTexture.OnFrameAvailableListener {
    private static final String TAG="my_tag_MyCameraRender";
    ...
    public MyCameraRender(Context context) {
        Log.d(TAG,"MyCameraRender constructor");
    ...
    public void onSurfaceCreated() {
        Log.d(TAG,"MyCameraRender onSurfaceCreated +");

//        Exception e = new Exception("my_tag_onSurfaceCreated");
//        e.printStackTrace();
    ...
    public void onSurfaceChanged(int width, int height) {
        Log.d(TAG,"MyCameraRender onSurfaceChanged width="+width+", height="+height);
    ...
    public void onDrawFrame() {
        Log.d(TAG,"MyCameraRender onDrawFrame +");
        ...
        screenRender.onDraw(fboTextureid);
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        Log.d(TAG,"MyCameraRender onFrameAvailable");
    }
