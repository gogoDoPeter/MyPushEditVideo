...
public class EncodecRender implements MyEGLSurfaceView.MyGLRender {
    private static final String TAG="my_tag_EncodecRender";
    ...
    public EncodecRender(Context context, int textureId) {
        ...
        Log.d(TAG,"EncodecRender +, textureId:"+textureId);
        bitmap = ShaderUtil.createTextImage("视频直播和推流：gogoDoPeter", 50, "#ff0000", "#00000000", 0);
    ...
    public void onSurfaceCreated() {
        ...
        Log.d(TAG,"onSurfaceCreated -, vboId:"+vboId+", bitmapTextureid:"+bitmapTextureid);
    }

    @Override
    public void onSurfaceChanged(int width, int height) {
        Log.d(TAG,"onSurfaceChanged +, SurfaceWidth:"+width+", SurfaceHeight:"+height);
    ...
    public void onDrawFrame() {
        ...
        Log.d(TAG,"onDrawFrame vboId:"+vboId+", textureid:"+ textureId +", bitmapTextureid:"+bitmapTextureid);
        GLES20.glEnableVertexAttribArray(vPosition);
        GLES20.glVertexAttribPointer(vPosition, 2, GLES20.GL_FLOAT, false, 8,
                32);
