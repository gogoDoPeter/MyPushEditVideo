package com.peter.videolibrary.player;
...
import com.peter.videolibrary.listener.*;
import com.peter.videolibrary.utils.MuteEnum;
import com.peter.videolibrary.utils.MyLog;
import com.peter.videolibrary.utils.TimeUtil;
...
public class AudioPlayer {
    private static final String TAG = "my_tag_" + AudioPlayer.class.getSimpleName();
...
//        System.loadLibrary("postproc-54");
    ...
    //mediacodec
    private static final int BUFFER_SIZE_IN_BYTES = 4096;   //TODO  底层做了分包，最大size是4096， 不用再设置4608
    ...
    public void startRecordCut(File saveFileName) {
        if (!bInitMediaCodec) {
            ...
            if (audioSamplerate > 0) {
                ...
                if (nativeCutAudioPlay(20., 40., true)) {
